    ...
    def _fix_distutils_import(self, arch):
        ...
        for root, dirs, files in os.walk(build_dir):
            ...
            for fname in files:
                ...
                # Fix all "from distutils.xxx import" -> "from setuptools._distutils.xxx import"
                # But handle msvccompiler as special case (not in setuptools._distutils)
                import re
                
                # Special: msvccompiler
                if 'from distutils.msvccompiler import get_build_version as get_build_msvc_version' in new_content:
                ...
                # but skip msvccompiler which is already handled
